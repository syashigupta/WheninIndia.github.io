function hashmapel(elem, key)
{
  ...
  document.getElementsByTagName('h3')[key-1].className = 'buttonselected';
...
function hashmap(key){
  ...
  dict[4]="&#x22;Bhel Puri is a popular street side food from India. Made using puffed rice and an amalgamation of spices and chutneys, it is a treat to the taste buds.&#x22;";
